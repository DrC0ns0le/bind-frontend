...
export const TextInput = forwardRef(({ className = "", ...props }, ref) => {
  return (
    <input
      ref={ref}
      type="text"
      className={`font-mono block px-2 rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-200 dark:bg-dark-elevated shadow-gb2 dark:shadow-dark-gb2 hover:shadow-gba2 dark:hover:shadow-dark-gba2 transition-smooth ring-1 ring-inset ring-gray-300 dark:ring-dark-border placeholder:text-gray-400 dark:placeholder:text-gray-600 focus:ring-2 focus:ring-inset focus:ring-gray-800 dark:focus:ring-gray-500 outline-none md:text-sm md:leading-6 ${className}`}
      {...props}
    />
  );
});

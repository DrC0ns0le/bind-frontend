  ...
  return (
    <>
      <button
        ...
        className={cn(
          "flex flex-row w-full text-left cursor-pointer border-t border-gray-200",
...
export function TableHeader({ children, className = "", showChevronSpace = false }) {
  return (
    <div className={cn(
      "flex flex-row items-center rounded-t-lg border border-gray-200 bg-gray-50",
      className
    )}>
...
export function TableRow({ children, className = "" }) {
  return (
    <div className={cn("flex flex-row items-center py-2 px-4", className)}>
      {children}
    </div>
  );
}

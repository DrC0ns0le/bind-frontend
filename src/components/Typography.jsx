...
export function PageHeading({ children, className = "", ...props }) {
  return (
    <h1
      className={`text-6xl sm:text-8xl font-black tracking-tight ${className}`}
      {...props}
    >
      {children}
    </h1>
...
export function Subheading({ children, className = "", ...props }) {
  return (
    <h2
      className={`text-2xl mt-4 ${className}`}
      {...props}
    >
      {children}
    </h2>
...
export function SectionLabel({ children, className = "", ...props }) {
  return (
    <h3
      className={`font-mono text-xl font-black p-2 pl-2 text-primary tracking-tight ${className}`}
      {...props}
    >
      {children}
    </h3>

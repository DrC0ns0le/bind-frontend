...
function Zone() {
    ...
    return (
      <Frame location="zones" breadcrumbs={[{ label: 'zones', path: '/zones' }]}>
        <div className="flex flex-col items-center justify-center h-screen text-primary">
          <p className="text-danger font-semibold mb-2">Error loading zone</p>
  ...
  return (
    <Frame location="zones" breadcrumbs={breadcrumbs}>
      <div>
        <p className="text-2xl font-black tracking-tight text-primary transition-smooth">
          ZONE
        </p>
      ...
      <div className="flex-wrap sm:gap-4 mt-12 min-w-[340px]">
        ...
        {error[1] ? (
          <div className="flex flex-col items-center justify-center pt-8 text-primary">
            <p className="text-danger font-semibold mb-2">Error loading records</p>
